...
The `bootanim` command copies the bootanimation file you selected to the `/data/local/tmp/bootanimation` folder.`service.sh` script runs on each reboot and binds `bootanimation.zip` to `/system/product/media/bootanimation.zip`.
